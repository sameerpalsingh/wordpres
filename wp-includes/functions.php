...
function wp_guess_url() {
	if ( defined('WP_SITEURL') && '' != WP_SITEURL ) {
		...
		if ( strpos( $_SERVER['REQUEST_URI'], 'wp-admin' ) !== false || strpos( $_SERVER['REQUEST_URI'], 'wp-adminlogin.php' ) !== false ) {
			$path = preg_replace( '#/(wp-admin/.*|wp-adminlogin.php)#i', '', $_SERVER['REQUEST_URI'] );
