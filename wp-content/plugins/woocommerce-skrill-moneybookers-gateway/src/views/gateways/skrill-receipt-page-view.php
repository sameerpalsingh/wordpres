<?php if(!defined('ABSPATH')) exit; // Exit if accessed directly
	...
	if($gateway_skrill->use_test_gateway()) {
...
<form id="skrill_form" method="post" action="<?php echo $skrill_url; ?>">
	<?php
		...
		echo implode("\n", $skrill_fields);
	?>
	<input id="skrill_submit" type="submit" value="<?php echo __('Pay via Skrill', $gateway_skrill->text_domain); ?>">
</form>
