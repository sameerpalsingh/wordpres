...
add_action( 'omega_footer', 'omega_get_footer_menu' );
...
function omega_register_menus() {
	...
	register_nav_menu( 'footer',   _x( 'Footer Menu', 'nav menu location', 'omega' ) );
}
 ...
 * @author Sameer
 */
function omega_get_footer_menu() {
	get_template_part( 'partials/menu', 'footermenu' );
}
